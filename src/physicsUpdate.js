...
import { rk4Integrate, getSOIHost, getRelativePosition, convertVelocityFrame, celestialBodies } from './physics.js';
import { stateToKepler, keplerToState } from './orbitalMechanics.js';

// SOI 边界诊断开关，发布前设为 false
const SOI_DIAG = (typeof window._soiDiag !== 'undefined') ? window._soiDiag : false;
