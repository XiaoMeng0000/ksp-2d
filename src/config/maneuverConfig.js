...
// 机动节点系统配置（0.2.5）— 全部可调参数集中于此，业务模块不硬编码
...
export const MANEUVER_CONFIG = {
    ...
    // 手柄速率式拖拽（0.2.5 打磨）：拖拽距离（沿轴向，**从图标初始位置起算**）→ 每秒注入 Δv
    ...
    nodeHitRadius: 12,
    handleHitRadius: 15,
    // 手柄相对节点图标中心的屏幕偏移（CSS 像素，四向对称；0.2.5 打磨 1.5× 放大）
    handleOffset: 51,
