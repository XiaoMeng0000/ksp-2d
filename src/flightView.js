...
// 机动视图可用性（总监定稿 0.2.5）：只要有活动飞船即可用（深空/绕恒星不再禁用）
...
class FlightView {
    ...
    /**
     * 切回普通聚焦视图：**平滑移动回飞船**并恢复进入前的缩放（0.2.5 平滑过渡）
    ...
    /**
     * 切换聚焦天体（下拉菜单调用）：**平滑移动**到目标天体 + **平滑缩放**到其上限（0.2.5）
